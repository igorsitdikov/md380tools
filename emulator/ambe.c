...
void encode_wav_file(char *infilename,
    ...
    while ((160 * 2) == read(wavfd, inbuf, 160 * 2)) {
        ...
        packed[0] = 0;
        packed[1] = ambe[7] | ambe[6] << 1 | ambe[5] << 2 | ambe[4] << 3 | ambe[3] << 4 | ambe[2] << 5 | ambe[1] << 6 |
                    ambe[0] << 7;
        packed[2] = ambe[15] | ambe[14] << 1 | ambe[13] << 2 | ambe[12] << 3 | ambe[11] << 4 | ambe[10] << 5 |
                    ambe[9] << 6 | ambe[8] << 7;
        packed[3] = ambe[23] | ambe[22] << 1 | ambe[21] << 2 | ambe[20] << 3 | ambe[19] << 4 | ambe[18] << 5 |
                    ambe[17] << 6 | ambe[16] << 7;
        packed[4] = ambe[31] | ambe[30] << 1 | ambe[29] << 2 | ambe[28] << 3 | ambe[27] << 4 | ambe[26] << 5 |
                    ambe[25] << 6 | ambe[24] << 7;
        packed[5] = ambe[39] | ambe[38] << 1 | ambe[37] << 2 | ambe[36] << 3 | ambe[35] << 4 | ambe[34] << 5 |
                    ambe[33] << 6 | ambe[32] << 7;
        packed[6] = ambe[47] | ambe[46] << 1 | ambe[45] << 2 | ambe[44] << 3 | ambe[43] << 4 | 0;

//        packed[6] = 0 | ambe[44] << 3 | ambe[43] << 4 | ambe[42] << 5 |
//                    ambe[41] << 6 | ambe[40] << 7;
        packed[7] = 0;
